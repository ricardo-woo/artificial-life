...
BUSH_MIN_DISTANCE = 400

PREY_POPULATION_SIZE = 150
PREDATOR_POPULATION_SIZE = 30
PARENT_COUNT = 10

# Food
FOOD_COUNT = 300
FOOD_RESPAWN_INTERVAL = 0.5
FOOD_ENERGY_VAL = 50
FOOD_RADIUS = 4
...
REPRODUCTION_CHILD_ENERGY = 40

REPRODUCTION_AGE = 100
PREY_REPRODUCTION_AGE = 60
...
PREDATOR_ATTACK_ANGLE = RAY_FOV_PREDATORS
...
# Neural Network
INPUTS = (NUM_RAYS * (len(RAY_CATEGORIES) + 1)) + 3
HIDDEN = 10
OUTPUTS = 2
...
PREY_SPRITE = pygame.image.load("assets/prey.png")
PREDATOR_SPRITE = pygame.image.load("assets/predator.png")
